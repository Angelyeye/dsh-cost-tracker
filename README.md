...
The suite covers storage, pricing, configuration, recomputation, cloud-read behavior, cloud-view behavior, sync, view normalization, Project Studios package identity, English active surfaces, privacy defaults, DSH-core isolation, and owner-only persistence expectations.
...
- latest verified branch head before this documentation change: `917efb303faf139ed990825542470abf28bed527`.
